  ...
  return (
    <div className="px-3 py-4 sm:px-5 sm:py-6 lg:px-8">
      <AtmosphericPanel
        ...
        contentClassName="grid min-h-[calc(100vh-6rem)] gap-6 p-5 sm:p-8 lg:grid-cols-[1.08fr_0.92fr] lg:p-10"
      >
        <div className="flex flex-col justify-between gap-8">
          <div className="object-card p-6 sm:p-8 lg:min-h-[31rem]">
            <p className="meta-label">Public cooling catalogue</p>
            <h1 className="display-tight mt-6 max-w-5xl text-balance text-7xl text-black sm:text-8xl lg:text-[8.5rem]">
              ZERO / 0°
            </h1>
        ...
        <div className="grid gap-4 lg:grid-rows-[1fr_auto]">
          <div className="object-card flex min-h-[26rem] flex-col justify-between p-5 sm:p-7">
            <div className="flex items-start justify-between gap-5">
              ...
              <p className="display-tight tabular text-7xl text-black sm:text-8xl">
                0°
              </p>
            </div>
